...
> [!WARNING]
> ここを間違えるとテストの採点が行われないので間違えないようにしてください。
...
まず、自分の書いた内容をgithubにコミットしてpushしてください。(コミットメッセージは指定はありません。)
> [!NOTE]
> コミットする際にエラーが出た場合はコードに構文エラー(そもそもコードが動かない)がある可能性があります。エラー文を読んで修正してください。
